          ...
          return (
            <div key={index} className="relative pl-6 pb-16">
              <div className="flex items-center gap-3 mb-8 relative z-20">
                ...
                <SeconderyButton text={step.title} shadow={'#e84d4d'}></SeconderyButton>
              </div>
              ...
              {/* Content Grid */}
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 bg-white shadow-md p-6 rounded-lg relative z-20">
                {/* Left Section */}
                <div>
                  <div className="grid grid-cols-12 gap-2">
                    ...
                    {step.moreImages.map((img, i) => (
                      <div key={i} className="col-span-4 h-[125px]">
                        <img
                          className="w-full h-full object-cover rounded-md"
                          src={img}
                          alt=""
