 ...
 <section>
    <AdminAddDestination/>
     ...
     <AdminMessageSection/>
      ...
      <Link to={'/admin-dashboard/admin-itinerary/details-destination'} className="flex justify-center mb-4"><SeconderyButton text={'Generate'} shadow={'#2DAD9D'}></SeconderyButton></Link>
    </div>
  );
};
