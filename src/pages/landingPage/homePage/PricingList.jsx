    ...
    <div className="min-h-screen px-4  lg:pb-11">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 px-4 sm:px-6 lg:px-0">
          <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-semibold text-gray-900 mb-4 leading-snug">
            Pricing for <span className="text-[#E66CE5]">every traveler</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl font-normal text-black max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto leading-relaxed">
