...
const TeamIntroduce = () => {
  return (
    <div className="min-h-screen py-16 sm:py-20 lg:py-28 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16 sm:mb-20 lg:mb-28">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 leading-snug">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 max-w-6xl mx-auto">
          {/* Cyber Bunny Card */}
          <div className="relative bg-white rounded-3xl p-6 sm:p-8 [box-shadow:6px_6px_15px_#FFC0CB]">
            {/* Quote Mark */}
            <div className="absolute -top-8 -right-4 w-16 h-16 sm:w-20 sm:h-20 bg-pink-100 rounded-full flex items-center justify-center">
              <img
                src="/rabbit.svg"
                alt="Quote Mark"
            ...
            <div className="text-center mb-4 sm:mb-6">
              <div className="w-40 h-40 sm:w-52 sm:h-52 mx-auto mb-4 rounded-full overflow-hidden">
                <img
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-pink-500 mb-1">
                Cyber Bunny
              </h3>
            ...
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed font-medium text-center">
