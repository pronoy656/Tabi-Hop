    ...
    <div className="min-h-screen py-32 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-semibold text-gray-800 mb-4">
            Latest Travel <span className="text-[#E66CE5]">Stories</span>{' '}
          </h1>
          <p className="text-gray-900 font-normal text-xl lg:text-2xl max-w-2xl mx-auto">
