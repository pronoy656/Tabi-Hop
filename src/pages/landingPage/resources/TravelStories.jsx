  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Form Section */}
        <div className="bg-[#3525c714] rounded-xl  p-8 sm:p-12">
          {/* File Upload Area */}
          <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <Input
                ...
                className="w-full h-12 px-4 border border-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <Select
                ...
                className="w-full h-12 px-4 border border-gray-400 bg-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ></Select>
            </div>
          </div>
          ...
          <div className="max-w-xl mx-auto">
            <button
              type="submit"
              className="w-full bg-[#6B5DE0] outline outline-[#6B5DE0] text-white py-4 font-medium rounded-md 
